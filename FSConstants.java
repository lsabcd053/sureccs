...
public interface FSConstants {
  ...
  public static final byte OP_CODING_BLOCK = (byte)85;
  ...
  // TODO robin添加的代码，编码参数，包括：
  // 1. RSn  编码后的总块数；
  // 2. RSm  编码需要的原始分块数；
  // So we have a default value here, though it may set to be
  // adjusted.
  public static final int RSn = 5; 
  public static final int RSm = 4;
}
